(function ( $, x5engine ) {
	...
	s.siteId = 'F012CB19F23C5B35C2873EA83284E2C1';
	s.islocal = true;
	s.version = '2021-1-4-1';
	b.push(function () {
		x.setupDateTime();
	...
	b.push(function () {
		x5engine.captcha.instance = new x5engine.captcha.x5captcha({
			"offlineCodes": {
				"0": { letter: 'F', path: 'captcha/imcpa_kdj.gif'},
				"1": { letter: '6', path: 'captcha/imcpa_e4f.gif'},
				"2": { letter: 'N', path: 'captcha/imcpa_vcg.gif'},
				"3": { letter: 'E', path: 'captcha/imcpa_lux.gif'},
				"4": { letter: '4', path: 'captcha/imcpa_gh8.gif'},
				"5": { letter: 'Y', path: 'captcha/imcpa_slc.gif'},
				"6": { letter: 'R', path: 'captcha/imcpa_dhs.gif'},
				"7": { letter: 'X', path: 'captcha/imcpa_wzk.gif'},
				"8": { letter: 'Z', path: 'captcha/imcpa_s4f.gif'},
				"9": { letter: 'F', path: 'captcha/imcpa_5ae.gif'}
			}
		});
	}, false, 'first');
	...
	s.breakPoints.push({"name": "Breakpoint 1", "hash": "07f764395c46c40d33c90e238c21033b", "start": 1149.9, "end": 800, "fluid": false});
	s.breakPoints.push({"name": "Mobile", "hash": "72e5146e7d399bc2f8a12127e43469f1", "start": 799.9, "end": 480, "fluid": false});
